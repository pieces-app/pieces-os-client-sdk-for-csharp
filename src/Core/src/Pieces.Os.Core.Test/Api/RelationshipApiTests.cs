...
namespace Pieces.Os.Core.Test.Api
{
    ...
    public class RelationshipApiTests : IDisposable
    {
        ...
        /// <summary>
        /// Test RelationshipsSpecificRelationshipSnapshot
        /// </summary>
        [Fact]
        public void RelationshipsSpecificRelationshipSnapshotTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string relationship = null;
            //var response = instance.RelationshipsSpecificRelationshipSnapshot(relationship);
            //Assert.IsType<Relationship>(response);
        }
    }
}
