...
namespace Pieces.Os.Core.SdkModel
{
    ...
    /// </summary>
    [DataContract(Name = "WorkstreamEvents")]
    public partial class WorkstreamEvents : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WorkstreamEvents" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected WorkstreamEvents() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="WorkstreamEvents" /> class.
        /// </summary>
        ...
        public WorkstreamEvents(EmbeddedModelSchema schema = default(EmbeddedModelSchema), List<WorkstreamEvent> iterable = default(List<WorkstreamEvent>), Dictionary<string, int> indices = default(Dictionary<string, int>), Score score = default(Score))
        {
            // to ensure "iterable" is required (not null)
            if (iterable == null)
            {
                throw new ArgumentNullException("iterable is a required property for WorkstreamEvents and cannot be null");
            }
        ...
        public List<WorkstreamEvent> Iterable { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WorkstreamEvents {\n");
