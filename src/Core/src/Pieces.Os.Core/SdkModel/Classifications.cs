...
namespace Pieces.Os.Core.SdkModel
{
    ...
    public partial class Classifications : IValidatableObject
    {
        /// <summary>
        ...
        public Classifications(EmbeddedModelSchema schema = default(EmbeddedModelSchema), List<Classification> iterable = default(List<Classification>))
        {
            // to ensure "iterable" is required (not null)
            if (iterable == null)
            {
                throw new ArgumentNullException("iterable is a required property for Classifications and cannot be null");
            }
