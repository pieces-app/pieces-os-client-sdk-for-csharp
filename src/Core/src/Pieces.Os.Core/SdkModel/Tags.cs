...
namespace Pieces.Os.Core.SdkModel
{
    ...
    public partial class Tags : IValidatableObject
    {
        ...
        public Tags(EmbeddedModelSchema schema = default(EmbeddedModelSchema), List<Tag> iterable = default(List<Tag>), Dictionary<string, int> indices = default(Dictionary<string, int>), Score score = default(Score))
        {
            // to ensure "iterable" is required (not null)
            if (iterable == null)
            {
                throw new ArgumentNullException("iterable is a required property for Tags and cannot be null");
            }
        ...
        public List<Tag> Iterable { get; set; }
