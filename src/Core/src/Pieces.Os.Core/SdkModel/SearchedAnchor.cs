...
namespace Pieces.Os.Core.SdkModel
{
    ...
    /// </summary>
    [DataContract(Name = "SearchedAnchor")]
    public partial class SearchedAnchor : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SearchedAnchor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SearchedAnchor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SearchedAnchor" /> class.
        /// </summary>
        ...
        /// <param name="identifier">This is the uuid of the anchor. (required).</param>
        public SearchedAnchor(EmbeddedModelSchema schema = default(EmbeddedModelSchema), Anchor anchor = default(Anchor), SearchedAnchorPoints points = default(SearchedAnchorPoints), bool exact = default(bool), decimal similarity = default(decimal), bool temporal = default(bool), string identifier = default(string))
        {
            this.Exact = exact;
            ...
            if (identifier == null)
            {
                throw new ArgumentNullException("identifier is a required property for SearchedAnchor and cannot be null");
            }
        ...
        public SearchedAnchorPoints Points { get; set; }
        ...
        /// </summary>
        /// <value>This is the uuid of the anchor.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SearchedAnchor {\n");
