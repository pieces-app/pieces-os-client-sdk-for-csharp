...
namespace Pieces.Os.Core.SdkModel
{
    ...
    /// </summary>
    [DataContract(Name = "SearchInput")]
    public partial class SearchInput : IValidatableObject
    {
        /// <summary>
        ...
        public SearchInput(EmbeddedModelSchema schema = default(EmbeddedModelSchema), SearchEngines engines = default(SearchEngines))
        {
            // to ensure "engines" is required (not null)
            if (engines == null)
            {
                throw new ArgumentNullException("engines is a required property for SearchInput and cannot be null");
            }
