...
namespace Pieces.Os.Core.SdkModel
{
    ...
    /// </summary>
    [DataContract(Name = "FlattenedWebsite")]
    public partial class FlattenedWebsite : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FlattenedWebsite" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected FlattenedWebsite() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="FlattenedWebsite" /> class.
        /// </summary>
        /// <param name="schema">schema.</param>
        /// <param name="id">this is aspecific uuid that represents (required).</param>
        /// <param name="assets">assets.</param>
        /// <param name="name">A customizable name. (required).</param>
        /// <param name="url">The true url or the website. (required).</param>
        ...
        public FlattenedWebsite(EmbeddedModelSchema schema = default(EmbeddedModelSchema), string id = default(string), FlattenedAssets assets = default(FlattenedAssets), string name = default(string), string url = default(string), GroupedTimestamp created = default(GroupedTimestamp), GroupedTimestamp updated = default(GroupedTimestamp), GroupedTimestamp deleted = default(GroupedTimestamp), Dictionary<string, MechanismEnum> mechanisms = default(Dictionary<string, MechanismEnum>), int interactions = default(int), FlattenedPersons persons = default(FlattenedPersons), FlattenedConversations conversations = default(FlattenedConversations), Score score = default(Score), FlattenedWorkstreamSummaries summaries = default(FlattenedWorkstreamSummaries), FlattenedConversationMessages messages = default(FlattenedConversationMessages))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for FlattenedWebsite and cannot be null");
            }
            this.Id = id;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for FlattenedWebsite and cannot be null");
            }
            this.Name = name;
            // to ensure "url" is required (not null)
            if (url == null)
            {
                throw new ArgumentNullException("url is a required property for FlattenedWebsite and cannot be null");
            }
            this.Url = url;
            // to ensure "created" is required (not null)
            if (created == null)
            {
                throw new ArgumentNullException("created is a required property for FlattenedWebsite and cannot be null");
            }
            this.Created = created;
            // to ensure "updated" is required (not null)
            if (updated == null)
            {
                throw new ArgumentNullException("updated is a required property for FlattenedWebsite and cannot be null");
            }
        ...
        /// </summary>
        /// <value>this is aspecific uuid that represents</value>
        ...
        /// A customizable name.
        /// </summary>
        /// <value>A customizable name.</value>
        ...
        /// </summary>
        /// <value>The true url or the website.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FlattenedWebsite {\n");
