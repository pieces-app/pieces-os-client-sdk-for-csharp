...
namespace Pieces.Os.Core.SdkModel
{
    ...
    public partial class FileFormat : IValidatableObject
    {
        /// <summary>
        ...
        public FileFormat(EmbeddedModelSchema schema = default(EmbeddedModelSchema), TransferableBytes bytes = default(TransferableBytes), TransferableString varString = default(TransferableString))
        {
            this.Schema = schema;
            this.Bytes = bytes;
