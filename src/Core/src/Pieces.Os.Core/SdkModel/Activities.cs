...
namespace Pieces.Os.Core.SdkModel
{
    ...
    public partial class Activities : IValidatableObject
    {
        ...
        public Activities(EmbeddedModelSchema schema = default(EmbeddedModelSchema), List<Activity> iterable = default(List<Activity>))
        {
            // to ensure "iterable" is required (not null)
            if (iterable == null)
            {
                throw new ArgumentNullException("iterable is a required property for Activities and cannot be null");
            }
        ...
        public List<Activity> Iterable { get; set; }
