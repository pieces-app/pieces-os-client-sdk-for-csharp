...
namespace Pieces.Os.Core.SdkModel
{
    ...
    /// </summary>
    [DataContract(Name = "PreonboardedPersonaDetails")]
    public partial class PreonboardedPersonaDetails : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PreonboardedPersonaDetails" /> class.
        /// </summary>
        /// <param name="schema">schema.</param>
        /// <param name="languages">languages.</param>
        /// <param name="personas">personas.</param>
        public PreonboardedPersonaDetails(EmbeddedModelSchema schema = default(EmbeddedModelSchema), List<string> languages = default(List<string>), List<string> personas = default(List<string>))
        {
            this.Schema = schema;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PreonboardedPersonaDetails {\n");
