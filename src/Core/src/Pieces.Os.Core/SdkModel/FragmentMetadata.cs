...
namespace Pieces.Os.Core.SdkModel
{
    ...
    public partial class FragmentMetadata : IValidatableObject
    {
        ...
        public FragmentMetadata(EmbeddedModelSchema schema = default(EmbeddedModelSchema), ClassificationSpecificEnum? ext = default(ClassificationSpecificEnum?))
        {
            this.Schema = schema;
            this.Ext = ext;
        }
