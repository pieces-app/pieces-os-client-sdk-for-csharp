...
namespace Pieces.Os.Core.SdkModel
{
    ...
    /// </summary>
    [DataContract(Name = "Models")]
    public partial class Models : IValidatableObject
    {
        /// <summary>
        ...
        public Models(EmbeddedModelSchema schema = default(EmbeddedModelSchema), List<Model> iterable = default(List<Model>))
        {
            ...
            if (iterable == null)
            {
                throw new ArgumentNullException("iterable is a required property for Models and cannot be null");
            }
