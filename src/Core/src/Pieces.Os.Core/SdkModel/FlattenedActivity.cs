...
namespace Pieces.Os.Core.SdkModel
{
    ...
    /// </summary>
    [DataContract(Name = "FlattenedActivity")]
    public partial class FlattenedActivity : IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FlattenedActivity" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected FlattenedActivity() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="FlattenedActivity" /> class.
        /// </summary>
        ...
        public FlattenedActivity(EmbeddedModelSchema schema = default(EmbeddedModelSchema), string id = default(string), GroupedTimestamp created = default(GroupedTimestamp), GroupedTimestamp updated = default(GroupedTimestamp), SeededConnectorTracking varEvent = default(SeededConnectorTracking), Application application = default(Application), GroupedTimestamp deleted = default(GroupedTimestamp), ReferencedAsset asset = default(ReferencedAsset), ReferencedFormat format = default(ReferencedFormat), FlattenedUserProfile user = default(FlattenedUserProfile), MechanismEnum mechanism = default(MechanismEnum), int rank = default(int))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for FlattenedActivity and cannot be null");
            }
            this.Id = id;
            // to ensure "created" is required (not null)
            if (created == null)
            {
                throw new ArgumentNullException("created is a required property for FlattenedActivity and cannot be null");
            }
            this.Created = created;
            // to ensure "updated" is required (not null)
            if (updated == null)
            {
                throw new ArgumentNullException("updated is a required property for FlattenedActivity and cannot be null");
            }
            ...
            if (application == null)
            {
                throw new ArgumentNullException("application is a required property for FlattenedActivity and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FlattenedActivity {\n");
