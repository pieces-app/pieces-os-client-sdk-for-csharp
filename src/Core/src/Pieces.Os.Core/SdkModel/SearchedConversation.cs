...
namespace Pieces.Os.Core.SdkModel
{
    ...
    /// </summary>
    [DataContract(Name = "SearchedConversation")]
    public partial class SearchedConversation : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SearchedConversation" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SearchedConversation() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SearchedConversation" /> class.
        /// </summary>
        ...
        /// <param name="identifier">This is the uuid of the conversation. (required).</param>
        public SearchedConversation(EmbeddedModelSchema schema = default(EmbeddedModelSchema), Conversation conversation = default(Conversation), SearchedConversationMessages messages = default(SearchedConversationMessages), SearchedAnnotations annotations = default(SearchedAnnotations), bool exact = default(bool), decimal similarity = default(decimal), bool temporal = default(bool), string identifier = default(string))
        {
            this.Exact = exact;
            ...
            if (identifier == null)
            {
                throw new ArgumentNullException("identifier is a required property for SearchedConversation and cannot be null");
            }
        ...
        public SearchedConversationMessages Messages { get; set; }

        /// <summary>
        /// Gets or Sets Annotations
        /// </summary>
        [DataMember(Name = "annotations", EmitDefaultValue = false)]
        public SearchedAnnotations Annotations { get; set; }
        ...
        /// </summary>
        /// <value>This is the uuid of the conversation.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SearchedConversation {\n");
