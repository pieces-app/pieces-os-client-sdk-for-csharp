...
namespace Pieces.Os.Core.SdkModel
{
    ...
    public partial class Analysis : IValidatableObject
    {
        ...
        public Analysis(EmbeddedModelSchema schema = default(EmbeddedModelSchema), CodeAnalysis code = default(CodeAnalysis), string id = default(string), string format = default(string), ImageAnalysis image = default(ImageAnalysis))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for Analysis and cannot be null");
            }
            this.Id = id;
            // to ensure "format" is required (not null)
            if (format == null)
            {
                throw new ArgumentNullException("format is a required property for Analysis and cannot be null");
            }
            this.Format = format;
            this.Schema = schema;
            this.Code = code;
        ...
        public ImageAnalysis Image { get; set; }
