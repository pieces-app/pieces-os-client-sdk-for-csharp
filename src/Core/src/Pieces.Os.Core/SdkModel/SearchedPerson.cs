...
namespace Pieces.Os.Core.SdkModel
{
    ...
    /// </summary>
    [DataContract(Name = "SearchedPerson")]
    public partial class SearchedPerson : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SearchedPerson" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SearchedPerson() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SearchedPerson" /> class.
        /// </summary>
        ...
        /// <param name="identifier">This is the uuid of the person. (required).</param>
        public SearchedPerson(EmbeddedModelSchema schema = default(EmbeddedModelSchema), Person person = default(Person), bool exact = default(bool), decimal similarity = default(decimal), bool temporal = default(bool), string identifier = default(string))
        {
            this.Exact = exact;
            ...
            if (identifier == null)
            {
                throw new ArgumentNullException("identifier is a required property for SearchedPerson and cannot be null");
            }
        ...
        /// </summary>
        /// <value>This is the uuid of the person.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SearchedPerson {\n");
