...
namespace Pieces.Os.Core.SdkModel
{
    ...
    /// </summary>
    [DataContract(Name = "SeededWorkstreamSummary")]
    public partial class SeededWorkstreamSummary : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SeededWorkstreamSummary" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SeededWorkstreamSummary() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SeededWorkstreamSummary" /> class.
        /// </summary>
        ...
        public SeededWorkstreamSummary(EmbeddedModelSchema schema = default(EmbeddedModelSchema), FlattenedWorkstreamEvents events = default(FlattenedWorkstreamEvents), string name = default(string), List<SeededAnnotation> annotations = default(List<SeededAnnotation>), FlattenedRanges ranges = default(FlattenedRanges), Model model = default(Model), FlattenedWebsites websites = default(FlattenedWebsites), FlattenedAnchors anchors = default(FlattenedAnchors), FlattenedAssets assets = default(FlattenedAssets), FlattenedConversations conversations = default(FlattenedConversations), FlattenedPersons persons = default(FlattenedPersons), Applications applications = default(Applications))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for SeededWorkstreamSummary and cannot be null");
            }
            this.Name = name;
            // to ensure "model" is required (not null)
            if (model == null)
            {
                throw new ArgumentNullException("model is a required property for SeededWorkstreamSummary and cannot be null");
            }
            this.Model = model;
            this.Schema = schema;
            this.Events = events;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SeededWorkstreamSummary {\n");
