...
namespace Pieces.Os.Core.SdkModel
{
    ...
    public partial class Seeds : IValidatableObject
    {
        /// <summary>
        ...
        public Seeds(EmbeddedModelSchema schema = default(EmbeddedModelSchema), List<Seed> iterable = default(List<Seed>))
        {
            // to ensure "iterable" is required (not null)
            if (iterable == null)
            {
                throw new ArgumentNullException("iterable is a required property for Seeds and cannot be null");
            }
        ...
        public List<Seed> Iterable { get; set; }
