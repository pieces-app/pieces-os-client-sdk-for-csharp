...
namespace Pieces.Os.Core.SdkModel
{
    ...
    /// </summary>
    [DataContract(Name = "FlattenedHint")]
    public partial class FlattenedHint : IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FlattenedHint" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected FlattenedHint() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="FlattenedHint" /> class.
        /// </summary>
        ...
        public FlattenedHint(EmbeddedModelSchema schema = default(EmbeddedModelSchema), string id = default(string), GroupedTimestamp created = default(GroupedTimestamp), GroupedTimestamp updated = default(GroupedTimestamp), GroupedTimestamp deleted = default(GroupedTimestamp), Dictionary<string, MechanismEnum> mechanisms = default(Dictionary<string, MechanismEnum>), FlattenedAssets assets = default(FlattenedAssets), HintTypeEnum type = default(HintTypeEnum), string text = default(string), ReferencedModel model = default(ReferencedModel), Score score = default(Score))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for FlattenedHint and cannot be null");
            }
            this.Id = id;
            // to ensure "created" is required (not null)
            if (created == null)
            {
                throw new ArgumentNullException("created is a required property for FlattenedHint and cannot be null");
            }
            this.Created = created;
            // to ensure "updated" is required (not null)
            if (updated == null)
            {
                throw new ArgumentNullException("updated is a required property for FlattenedHint and cannot be null");
            }
            ...
            if (text == null)
            {
                throw new ArgumentNullException("text is a required property for FlattenedHint and cannot be null");
            }
            this.Text = text;
            this.Schema = schema;
