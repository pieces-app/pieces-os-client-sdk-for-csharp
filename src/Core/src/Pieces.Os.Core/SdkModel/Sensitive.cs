...
namespace Pieces.Os.Core.SdkModel
{
    ...
    /// </summary>
    [DataContract(Name = "Sensitive")]
    public partial class Sensitive : IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Sensitive" /> class.
        /// </summary>
        ...
        public Sensitive(EmbeddedModelSchema schema = default(EmbeddedModelSchema), string id = default(string), GroupedTimestamp created = default(GroupedTimestamp), GroupedTimestamp updated = default(GroupedTimestamp), GroupedTimestamp deleted = default(GroupedTimestamp), FlattenedAsset asset = default(FlattenedAsset), string text = default(string), MechanismEnum mechanism = default(MechanismEnum), SensitiveCategoryEnum category = default(SensitiveCategoryEnum), SensitiveSeverityEnum severity = default(SensitiveSeverityEnum), string name = default(string), string description = default(string), SensitiveMetadata metadata = default(SensitiveMetadata), int interactions = default(int), Score score = default(Score))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for Sensitive and cannot be null");
            }
            this.Id = id;
            // to ensure "created" is required (not null)
            if (created == null)
            {
                throw new ArgumentNullException("created is a required property for Sensitive and cannot be null");
            }
            this.Created = created;
            // to ensure "updated" is required (not null)
            if (updated == null)
            {
                throw new ArgumentNullException("updated is a required property for Sensitive and cannot be null");
            }
            this.Updated = updated;
            // to ensure "asset" is required (not null)
            if (asset == null)
            {
                throw new ArgumentNullException("asset is a required property for Sensitive and cannot be null");
            }
            this.Asset = asset;
            // to ensure "text" is required (not null)
            if (text == null)
            {
                throw new ArgumentNullException("text is a required property for Sensitive and cannot be null");
            }
            this.Text = text;
            ...
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for Sensitive and cannot be null");
            }
            this.Name = name;
            // to ensure "description" is required (not null)
            if (description == null)
            {
                throw new ArgumentNullException("description is a required property for Sensitive and cannot be null");
            }
