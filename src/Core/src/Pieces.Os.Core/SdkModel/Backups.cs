...
namespace Pieces.Os.Core.SdkModel
{
    ...
    /// </summary>
    [DataContract(Name = "Backups")]
    public partial class Backups : IValidatableObject
    {
        /// <summary>
        ...
        public Backups(EmbeddedModelSchema schema = default(EmbeddedModelSchema), List<Backup> iterable = default(List<Backup>), Dictionary<string, int> indices = default(Dictionary<string, int>), Score score = default(Score))
        {
            // to ensure "iterable" is required (not null)
            if (iterable == null)
            {
                throw new ArgumentNullException("iterable is a required property for Backups and cannot be null");
            }
        ...
        public List<Backup> Iterable { get; set; }
