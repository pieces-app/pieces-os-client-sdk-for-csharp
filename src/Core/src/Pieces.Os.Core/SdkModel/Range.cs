...
namespace Pieces.Os.Core.SdkModel
{
    ...
    public partial class Range : IValidatableObject
    {
        ...
        public Range(EmbeddedModelSchema schema = default(EmbeddedModelSchema), string id = default(string), Score score = default(Score), GroupedTimestamp created = default(GroupedTimestamp), GroupedTimestamp updated = default(GroupedTimestamp), GroupedTimestamp to = default(GroupedTimestamp), GroupedTimestamp from = default(GroupedTimestamp), bool between = default(bool), FlattenedWorkstreamSummaries summaries = default(FlattenedWorkstreamSummaries), FlattenedConversations conversations = default(FlattenedConversations))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for Range and cannot be null");
            }
            this.Id = id;
            // to ensure "created" is required (not null)
            if (created == null)
            {
                throw new ArgumentNullException("created is a required property for Range and cannot be null");
            }
            this.Created = created;
            // to ensure "updated" is required (not null)
            if (updated == null)
            {
                throw new ArgumentNullException("updated is a required property for Range and cannot be null");
            }
