...
namespace Pieces.Os.Core.SdkModel
{
    ...
    /// </summary>
    [DataContract(Name = "SeededTrackedFormatEvent")]
    public partial class SeededTrackedFormatEvent : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SeededTrackedFormatEvent" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SeededTrackedFormatEvent() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SeededTrackedFormatEvent" /> class.
        /// </summary>
        ...
        public SeededTrackedFormatEvent(EmbeddedModelSchema schema = default(EmbeddedModelSchema), TrackedFormatEventIdentifierDescriptionPairs identifierDescriptionPair = default(TrackedFormatEventIdentifierDescriptionPairs), ReferencedFormat format = default(ReferencedFormat), TrackedFormatEventMetadata metadata = default(TrackedFormatEventMetadata))
        {
            // to ensure "identifierDescriptionPair" is required (not null)
            if (identifierDescriptionPair == null)
            {
                throw new ArgumentNullException("identifierDescriptionPair is a required property for SeededTrackedFormatEvent and cannot be null");
            }
            this.IdentifierDescriptionPair = identifierDescriptionPair;
            // to ensure "format" is required (not null)
            if (format == null)
            {
                throw new ArgumentNullException("format is a required property for SeededTrackedFormatEvent and cannot be null");
            }
            this.Format = format;
            this.Schema = schema;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SeededTrackedFormatEvent {\n");
