...
namespace Pieces.Os.Core.SdkModel
{
    ...
    /// </summary>
    [DataContract(Name = "Hint")]
    public partial class Hint : IValidatableObject
    {
        ...
        public Hint(EmbeddedModelSchema schema = default(EmbeddedModelSchema), string id = default(string), GroupedTimestamp created = default(GroupedTimestamp), GroupedTimestamp updated = default(GroupedTimestamp), GroupedTimestamp deleted = default(GroupedTimestamp), Dictionary<string, MechanismEnum> mechanisms = default(Dictionary<string, MechanismEnum>), FlattenedAssets assets = default(FlattenedAssets), HintTypeEnum type = default(HintTypeEnum), string text = default(string), ReferencedModel model = default(ReferencedModel), Score score = default(Score))
        {
            ...
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for Hint and cannot be null");
            }
            this.Id = id;
            // to ensure "created" is required (not null)
            if (created == null)
            {
                throw new ArgumentNullException("created is a required property for Hint and cannot be null");
            }
            this.Created = created;
            // to ensure "updated" is required (not null)
            if (updated == null)
            {
                throw new ArgumentNullException("updated is a required property for Hint and cannot be null");
            }
            ...
            if (text == null)
            {
                throw new ArgumentNullException("text is a required property for Hint and cannot be null");
            }
            this.Text = text;
            this.Schema = schema;
