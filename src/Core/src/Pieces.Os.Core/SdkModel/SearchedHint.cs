...
namespace Pieces.Os.Core.SdkModel
{
    ...
    /// </summary>
    [DataContract(Name = "SearchedHint")]
    public partial class SearchedHint : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SearchedHint" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SearchedHint() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SearchedHint" /> class.
        /// </summary>
        ...
        /// <param name="identifier">This is the uuid of the hint. (required).</param>
        public SearchedHint(EmbeddedModelSchema schema = default(EmbeddedModelSchema), Hint hint = default(Hint), bool exact = default(bool), decimal similarity = default(decimal), bool temporal = default(bool), string identifier = default(string))
        {
            this.Exact = exact;
            ...
            if (identifier == null)
            {
                throw new ArgumentNullException("identifier is a required property for SearchedHint and cannot be null");
            }
        ...
        /// </summary>
        /// <value>This is the uuid of the hint.</value>
