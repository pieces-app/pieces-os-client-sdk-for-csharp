...
namespace Pieces.Os.Core.SdkModel
{
    ...
    /// </summary>
    [DataContract(Name = "FlattenedWebsites")]
    public partial class FlattenedWebsites : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FlattenedWebsites" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected FlattenedWebsites() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="FlattenedWebsites" /> class.
        /// </summary>
        ...
        public FlattenedWebsites(EmbeddedModelSchema schema = default(EmbeddedModelSchema), List<ReferencedWebsite> iterable = default(List<ReferencedWebsite>), Dictionary<string, int> indices = default(Dictionary<string, int>), Score score = default(Score))
        {
            // to ensure "iterable" is required (not null)
            if (iterable == null)
            {
                throw new ArgumentNullException("iterable is a required property for FlattenedWebsites and cannot be null");
            }
        ...
        public List<ReferencedWebsite> Iterable { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FlattenedWebsites {\n");
