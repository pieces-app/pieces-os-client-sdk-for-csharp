...
namespace Pieces.Os.Core.SdkModel
{
    ...
    public partial class Applications : IValidatableObject
    {
        ...
        public Applications(EmbeddedModelSchema schema = default(EmbeddedModelSchema), List<Application> iterable = default(List<Application>))
        {
            // to ensure "iterable" is required (not null)
            if (iterable == null)
            {
                throw new ArgumentNullException("iterable is a required property for Applications and cannot be null");
            }
        ...
        public List<Application> Iterable { get; set; }
