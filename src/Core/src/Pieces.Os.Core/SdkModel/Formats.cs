...
namespace Pieces.Os.Core.SdkModel
{
    ...
    public partial class Formats : IValidatableObject
    {
        /// <summary>
        ...
        public Formats(EmbeddedModelSchema schema = default(EmbeddedModelSchema), List<Format> iterable = default(List<Format>))
        {
            // to ensure "iterable" is required (not null)
            if (iterable == null)
            {
                throw new ArgumentNullException("iterable is a required property for Formats and cannot be null");
            }
        ...
        public List<Format> Iterable { get; set; }
