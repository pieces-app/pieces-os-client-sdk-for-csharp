...
namespace Pieces.Os.Core.Api
{
    ...
    /// </summary>
    public interface IRangesApiSync : IApiAccessor
    {
        ...
        /// <param name="seededRange"> (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>Range</returns>
        Range RangesCreateNewRange(SeededRange seededRange = default(SeededRange), int operationIndex = 0);
        ...
        ApiResponse<Range> RangesCreateNewRangeWithHttpInfo(SeededRange seededRange = default(SeededRange), int operationIndex = 0);
        /// <summary>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns></returns>
        void RangesDeleteSpecificRange(string range, int operationIndex = 0);
        ...
        ApiResponse<Object> RangesDeleteSpecificRangeWithHttpInfo(string range, int operationIndex = 0);
        /// <summary>
        /// /ranges [GET]
        /// </summary>
        /// <remarks>
        ...
        Ranges RangesSnapshot(int operationIndex = 0);
        ...
        /// <exception cref="Pieces.Os.Core.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Ranges</returns>
        ApiResponse<Ranges> RangesSnapshotWithHttpInfo(int operationIndex = 0);
        /// <summary>
        ...
        StreamedIdentifiers RangesStreamIdentifiers(int operationIndex = 0);
        ...
        ApiResponse<StreamedIdentifiers> RangesStreamIdentifiersWithHttpInfo(int operationIndex = 0);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IRangesApiAsync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IRangesApi : IRangesApiSync, IRangesApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class RangesApi : IRangesApi
    {
        private Pieces.Os.Core.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="RangesApi"/> class.
        /// </summary>
        /// <returns></returns>
        public RangesApi() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public RangesApi(string basePath)
        {
        ...
        /// <returns></returns>
        public RangesApi(Pieces.Os.Core.Client.Configuration configuration)
        {
        ...
        public RangesApi(Pieces.Os.Core.Client.ISynchronousClient client, Pieces.Os.Core.Client.IAsynchronousClient asyncClient, Pieces.Os.Core.Client.IReadableConfiguration configuration)
        {
        ...
        /// <summary>
        /// /ranges/create [POST] This will create a new Range in the database.
        /// </summary>
        /// <exception cref="Pieces.Os.Core.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="seededRange"> (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>Range</returns>
        public Range RangesCreateNewRange(SeededRange seededRange = default(SeededRange), int operationIndex = 0)
        {
            Pieces.Os.Core.Client.ApiResponse<Range> localVarResponse = RangesCreateNewRangeWithHttpInfo(seededRange);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Range</returns>
        public Pieces.Os.Core.Client.ApiResponse<Range> RangesCreateNewRangeWithHttpInfo(SeededRange seededRange = default(SeededRange), int operationIndex = 0)
        {
            ...
            localVarRequestOptions.Data = seededRange;
            ...
            {
                Exception _exception = this.ExceptionFactory("RangesCreateNewRange", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <summary>
        /// /ranges/{range}/delete [POST] This will delete a specific range from the database!
        /// </summary>
        /// <exception cref="Pieces.Os.Core.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="range">This is a identifier that is used to identify a specific range.</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns></returns>
        public void RangesDeleteSpecificRange(string range, int operationIndex = 0)
        {
            RangesDeleteSpecificRangeWithHttpInfo(range);
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public Pieces.Os.Core.Client.ApiResponse<Object> RangesDeleteSpecificRangeWithHttpInfo(string range, int operationIndex = 0)
        {
            // verify the required parameter 'range' is set
            if (range == null)
            {
                throw new Pieces.Os.Core.Client.ApiException(400, "Missing required parameter 'range' when calling RangesApi->RangesDeleteSpecificRange");
            }
            ...
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("RangesDeleteSpecificRange", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <summary>
        /// /ranges [GET] This will get a snapshot of all your ranges.
        /// </summary>
        /// <exception cref="Pieces.Os.Core.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>Ranges</returns>
        public Ranges RangesSnapshot(int operationIndex = 0)
        {
            Pieces.Os.Core.Client.ApiResponse<Ranges> localVarResponse = RangesSnapshotWithHttpInfo();
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Ranges</returns>
        public Pieces.Os.Core.Client.ApiResponse<Ranges> RangesSnapshotWithHttpInfo(int operationIndex = 0)
        {
            Pieces.Os.Core.Client.RequestOptions localVarRequestOptions = new Pieces.Os.Core.Client.RequestOptions();
            ...
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("RangesSnapshot", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <summary>
        /// /ranges/stream/identifiers [WS] Provides a WebSocket connection that emits changes to your range identifiers (UUIDs).
        /// </summary>
        /// <exception cref="Pieces.Os.Core.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>StreamedIdentifiers</returns>
        public StreamedIdentifiers RangesStreamIdentifiers(int operationIndex = 0)
        {
            Pieces.Os.Core.Client.ApiResponse<StreamedIdentifiers> localVarResponse = RangesStreamIdentifiersWithHttpInfo();
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of StreamedIdentifiers</returns>
        public Pieces.Os.Core.Client.ApiResponse<StreamedIdentifiers> RangesStreamIdentifiersWithHttpInfo(int operationIndex = 0)
        {
            Pieces.Os.Core.Client.RequestOptions localVarRequestOptions = new Pieces.Os.Core.Client.RequestOptions();
            ...
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("RangesStreamIdentifiers", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
